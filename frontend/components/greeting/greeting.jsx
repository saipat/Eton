...
// import SidebarContainer from '../xxxsidebar/sidebar_container';
    ...
    render(){
        return (<div>
				<div className="main">
					<div className="nav-bar">
                        ...
                        <a href="/">
							...
							<ul className="nav-links">
								<li>
									<a href="https://www.linkedin.com/in/saipat/">
						...
						<div className="nav-right">
							<Link to="/signup" className="e-links signup-link">
								Sign Up
							</Link>
							<p className="or">or</p>
							<Link to="/login" className="e-links login-link">
								Log In
							</Link>
						</div>
					</div>
					<div className="eton_home_bg">
						<div className="content">
							...
							<p>
								Evernote helps you capture and prioritize ideas, projects, and to-do lists, so
					...
					<div className="below-brain">
						...
						<div className="div3 brain-div">Never lose track of your tasks and deadlines.</div>
					</div>
				</div>
				...
				<div className="footer-row">
					...
					<img src={window.footerURL} alt="footer image" className="footer-image" />
				</div>
            </div>
        );
    };
